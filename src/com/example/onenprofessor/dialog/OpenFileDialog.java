...
public class OpenFileDialog {
	...
	static class FileSelectView extends ListView implements OnItemClickListener{  
		...
		{  
			...
			SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.dialog_file_item, new String[]{"img", "name", "path"}, new int[]{R.id.filedialogitem_img, R.id.filedialogitem_name, R.id.filedialogitem_path});  
